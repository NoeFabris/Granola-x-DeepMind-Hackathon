...
| Task | 06-full-video-generation-pipeline |
| Task # | 6 |
| Branch | hive/meeting-recap-feed/06-full-video-generation-pipeline |
| Worktree | /Users/noefabris/Coding/Granola-x-DeepMind-Hackathon/.hive/.worktrees/meeting-recap-feed/06-full-video-generation-pipeline |

**CRITICAL**: All file operations MUST be within this worktree path:
`/Users/noefabris/Coding/Granola-x-DeepMind-Hackathon/.hive/.worktrees/meeting-recap-feed/06-full-video-generation-pipeline`
...
- **5. video-stitching-service** (05-video-stitching-service)
